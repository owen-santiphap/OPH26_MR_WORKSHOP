	...
	public:
		FDisableMobileGPUSceneRule()
			: ISetupRule("Rendering_MobileGPUScene",
				  ...
				  NSLOCTEXT("OculusXRRenderingRules", "MobileGPUSceneLights_Description", "GPUScene is not compatible with MobileUniformLocalLights, EmulatedUniformBuffers, AppSpaceWarp, XR Soft Occlusions and LateLatching"),
				  ESetupRuleCategory::Rendering,
				  ESetupRuleSeverity::Performance,
				  MetaQuest_All) {}
