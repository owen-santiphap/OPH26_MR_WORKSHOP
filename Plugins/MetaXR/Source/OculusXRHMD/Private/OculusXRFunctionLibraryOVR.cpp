...
namespace OculusXRHMD
{
	...
	{
		auto Plugin = FOculusXRHMDModule::GetPluginWrapper();
		if (Plugin.GetNativeOpenXRHandles)
		{
			Plugin.GetNativeOpenXRHandles((ovrpUInt64*)OutXrInstance, (ovrpUInt64*)OutXrSession);
		}
		else
		{
			*OutXrInstance = 0;
