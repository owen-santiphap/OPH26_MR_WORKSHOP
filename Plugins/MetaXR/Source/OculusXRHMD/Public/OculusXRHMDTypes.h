...
struct FOculusXRPerformanceMetrics
{
	...
	/** App CPU Time (ms) */
	UPROPERTY(meta = (DeprecatedProperty, DeprecationMessage = "AppCpuTime is deprecated and not supported by OpenXR"))
	float AppCpuTime;
	...
	UPROPERTY(meta = (DeprecatedProperty, DeprecationMessage = "ComCpuTime is deprecated and not supported by OpenXR"))
	float ComCpuTime;
