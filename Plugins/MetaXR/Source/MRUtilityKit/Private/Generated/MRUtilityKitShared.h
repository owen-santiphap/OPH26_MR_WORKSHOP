...
struct MRUKShared
{
    ...
    bool (*FindLargestSurface)(Uuid roomUuid, LabelFilter labelFilter, Uuid* outSceneAnchorUuid);
...
private:
    ...
    void LoadNativeFunctions()
    {
        ...
        FindLargestSurface = reinterpret_cast<decltype(FindLargestSurface)>(LoadFunction(TEXT("FindLargestSurface")));
