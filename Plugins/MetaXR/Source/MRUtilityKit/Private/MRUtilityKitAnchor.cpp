...
void AMRUKAnchor::Setup(const FOculusXRUUID& Uuid, FOculusXRUInt64 Space, const FTransform& Transform, const TArray<FString>& Labels,
	const FBox2d& Plane, const TArray<FVector2D>& Boundary2D, const FBox3d& Volume, TArray<FVector> MeshPositions, TArray<int> MeshIndices)
{
