...
// ********** Begin Function CreateGuardian constinit property declarations ************************
	static const UECodeGen_Private::FObjectPropertyParams NewProp_GuardianMesh;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function CreateGuardian constinit property declarations **************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function CreateGuardian Property Definitions ***********************************
...
// ********** End Function CreateGuardian Property Definitions *************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMRUKGuardian_CreateGuardian_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMRUKGuardian, nullptr, "CreateGuardian", 	Z_Construct_UFunction_AMRUKGuardian_CreateGuardian_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_AMRUKGuardian_CreateGuardian_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_AMRUKGuardian_CreateGuardian_Statics::MRUKGuardian_eventCreateGuardian_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMRUKGuardian_CreateGuardian_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMRUKGuardian_CreateGuardian_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_AMRUKGuardian;
UClass* AMRUKGuardian::GetPrivateStaticClass()
{
	using TClass = AMRUKGuardian;
	if (!Z_Registration_Info_UClass_AMRUKGuardian.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MRUKGuardian"),
			Z_Registration_Info_UClass_AMRUKGuardian.InnerSingleton,
			StaticRegisterNativesAMRUKGuardian,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AMRUKGuardian.InnerSingleton;
}
UClass* Z_Construct_UClass_AMRUKGuardian_NoRegister()
{
	return AMRUKGuardian::GetPrivateStaticClass();
}
...
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "The Guardian is a procedural mesh that is generated from the anchor geometry and has the guardian material applied.\nIt is used to show the player where the walls and furniture. It prevents the player from walking into walls or furniture.\nIt uses TryGetClosestSurfacePosition to determine if the player is close to the walls or furniture.\nThis can be beneficial if your application has a full VR mode." },
#endif
	};
...
// ********** Begin Class AMRUKGuardian constinit property declarations ****************************
	static const UECodeGen_Private::FObjectPropertyParams NewProp_GuardianMeshComponent;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class AMRUKGuardian constinit property declarations ******************************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("CreateGuardian"), .Pointer = &AMRUKGuardian::execCreateGuardian },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMRUKGuardian_CreateGuardian, "CreateGuardian" }, // 1121582497
	};
...
// ********** Begin Class AMRUKGuardian Property Definitions ***************************************
...
// ********** End Class AMRUKGuardian Property Definitions *****************************************
...
void AMRUKGuardian::StaticRegisterNativesAMRUKGuardian()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_AMRUKGuardian_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, AMRUKGuardian);
AMRUKGuardian::~AMRUKGuardian() {}
// ********** End Class AMRUKGuardian **************************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitGuardian_h__Script_MRUtilityKit_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMRUKGuardian, AMRUKGuardian::StaticClass, TEXT("AMRUKGuardian"), &Z_Registration_Info_UClass_AMRUKGuardian, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMRUKGuardian), 76551967U) },
	};
}; // Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitGuardian_h__Script_MRUtilityKit_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitGuardian_h__Script_MRUtilityKit_1116397463{
	TEXT("/Script/MRUtilityKit"),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitGuardian_h__Script_MRUtilityKit_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitGuardian_h__Script_MRUtilityKit_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
