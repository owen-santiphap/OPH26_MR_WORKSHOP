...
UFunction* Z_Construct_UDelegateFunction_AMRUKDistanceMapGenerator_OnReady__DelegateSignature()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_AMRUKDistanceMapGenerator_OnReady__DelegateSignature_Statics::FuncParams);
	}
...
// ********** Begin Class AMRUKDistanceMapGenerator Function OnRoomUpdated *************************
struct Z_Construct_UFunction_AMRUKDistanceMapGenerator_OnRoomUpdated_Statics
{
	struct MRUKDistanceMapGenerator_eventOnRoomUpdated_Parms
	{
		AMRUKRoom* Room;
	};
#if WITH_METADATA
...
UFunction* Z_Construct_UFunction_AMRUKDistanceMapGenerator_OnRoomUpdated()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMRUKDistanceMapGenerator_OnRoomUpdated_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMRUKDistanceMapGenerator::execOnRoomUpdated)
{
	P_GET_OBJECT(AMRUKRoom,Z_Param_Room);
	P_FINISH;
	P_NATIVE_BEGIN;
...
// ********** End Class AMRUKDistanceMapGenerator Function OnRoomUpdated ***************************
...
{
	using TClass = AMRUKDistanceMapGenerator;
	...
	return Z_Registration_Info_UClass_AMRUKDistanceMapGenerator.InnerSingleton;
}
UClass* Z_Construct_UClass_AMRUKDistanceMapGenerator_NoRegister()
{
	return AMRUKDistanceMapGenerator::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitDistanceMapGenerator_h__Script_MRUtilityKit_Statics
{
...
}; // Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitDistanceMapGenerator_h__Script_MRUtilityKit_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitDistanceMapGenerator_h__Script_MRUtilityKit_4076215373{
	TEXT("/Script/MRUtilityKit"),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitDistanceMapGenerator_h__Script_MRUtilityKit_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitDistanceMapGenerator_h__Script_MRUtilityKit_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitDistanceMapGenerator_h__Script_MRUtilityKit_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitDistanceMapGenerator_h__Script_MRUtilityKit_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
