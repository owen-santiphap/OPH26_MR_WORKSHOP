...
// ********** End Function CalculateSeatPoses Property Definitions *********************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMRUKSeatsComponent_CalculateSeatPoses_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UMRUKSeatsComponent, nullptr, "CalculateSeatPoses", 	Z_Construct_UFunction_UMRUKSeatsComponent_CalculateSeatPoses_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UMRUKSeatsComponent_CalculateSeatPoses_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_UMRUKSeatsComponent_CalculateSeatPoses_Statics::MRUKSeatsComponent_eventCalculateSeatPoses_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMRUKSeatsComponent_CalculateSeatPoses_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMRUKSeatsComponent_CalculateSeatPoses_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UMRUKSeatsComponent;
UClass* UMRUKSeatsComponent::GetPrivateStaticClass()
{
	using TClass = UMRUKSeatsComponent;
	if (!Z_Registration_Info_UClass_UMRUKSeatsComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("MRUKSeatsComponent"),
			Z_Registration_Info_UClass_UMRUKSeatsComponent.InnerSingleton,
			StaticRegisterNativesUMRUKSeatsComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMRUKSeatsComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UMRUKSeatsComponent_NoRegister()
{
	return UMRUKSeatsComponent::GetPrivateStaticClass();
}
...
// ********** Begin Class UMRUKSeatsComponent constinit property declarations **********************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UMRUKSeatsComponent constinit property declarations ************************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("CalculateSeatPoses"), .Pointer = &UMRUKSeatsComponent::execCalculateSeatPoses },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UMRUKSeatsComponent_CalculateSeatPoses, "CalculateSeatPoses" }, // 924045358
	};
...
// ********** Begin Class UMRUKSeatsComponent Property Definitions *********************************
...
// ********** End Class UMRUKSeatsComponent Property Definitions ***********************************
...
void UMRUKSeatsComponent::StaticRegisterNativesUMRUKSeatsComponent()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_UMRUKSeatsComponent_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UMRUKSeatsComponent);
UMRUKSeatsComponent::~UMRUKSeatsComponent() {}
// ********** End Class UMRUKSeatsComponent ********************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSeatsComponent_h__Script_MRUtilityKit_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMRUKSeatsComponent, UMRUKSeatsComponent::StaticClass, TEXT("UMRUKSeatsComponent"), &Z_Registration_Info_UClass_UMRUKSeatsComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKSeatsComponent), 2464432407U) },
	};
}; // Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSeatsComponent_h__Script_MRUtilityKit_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSeatsComponent_h__Script_MRUtilityKit_3712727408{
	TEXT("/Script/MRUtilityKit"),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSeatsComponent_h__Script_MRUtilityKit_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSeatsComponent_h__Script_MRUtilityKit_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
