...
FClassRegistrationInfo Z_Registration_Info_UClass_UOculusXREditorSettings;
UClass* UOculusXREditorSettings::GetPrivateStaticClass()
{
	using TClass = UOculusXREditorSettings;
	if (!Z_Registration_Info_UClass_UOculusXREditorSettings.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("OculusXREditorSettings"),
			Z_Registration_Info_UClass_UOculusXREditorSettings.InnerSingleton,
			StaticRegisterNativesUOculusXREditorSettings,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UOculusXREditorSettings.InnerSingleton;
}
UClass* Z_Construct_UClass_UOculusXREditorSettings_NoRegister()
{
	return UOculusXREditorSettings::GetPrivateStaticClass();
}
...
// ********** Begin Class UOculusXREditorSettings constinit property declarations ******************
...
// ********** End Class UOculusXREditorSettings constinit property declarations ********************
...
// ********** Begin Class UOculusXREditorSettings Property Definitions *****************************
...
// ********** End Class UOculusXREditorSettings Property Definitions *******************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UOculusXREditorSettings);
UOculusXREditorSettings::~UOculusXREditorSettings() {}
// ********** End Class UOculusXREditorSettings ****************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXREditor_Public_OculusXREditorSettings_h__Script_OculusXREditor_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EOculusXRPlatform_StaticEnum, TEXT("EOculusXRPlatform"), &Z_Registration_Info_UEnum_EOculusXRPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1212971842U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOculusXREditorSettings, UOculusXREditorSettings::StaticClass, TEXT("UOculusXREditorSettings"), &Z_Registration_Info_UClass_UOculusXREditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXREditorSettings), 4206785057U) },
	};
}; // Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXREditor_Public_OculusXREditorSettings_h__Script_OculusXREditor_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXREditor_Public_OculusXREditorSettings_h__Script_OculusXREditor_1595997305{
	TEXT("/Script/OculusXREditor"),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXREditor_Public_OculusXREditorSettings_h__Script_OculusXREditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXREditor_Public_OculusXREditorSettings_h__Script_OculusXREditor_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXREditor_Public_OculusXREditorSettings_h__Script_OculusXREditor_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXREditor_Public_OculusXREditorSettings_h__Script_OculusXREditor_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
