...
{
	if (!Z_Registration_Info_UScriptStruct_FLutTextureData.InnerSingleton)
	{
...
{
	using TClass = UOculusXRPassthroughColorLut;
	...
	return Z_Registration_Info_UClass_UOculusXRPassthroughColorLut.InnerSingleton;
}
UClass* Z_Construct_UClass_UOculusXRPassthroughColorLut_NoRegister()
{
	return UOculusXRPassthroughColorLut::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRPassthrough_Public_OculusXRPassthroughColorLut_h__Script_OculusXRPassthrough_Statics
{
...
}; // Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRPassthrough_Public_OculusXRPassthroughColorLut_h__Script_OculusXRPassthrough_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRPassthrough_Public_OculusXRPassthroughColorLut_h__Script_OculusXRPassthrough_2637009406{
	TEXT("/Script/OculusXRPassthrough"),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRPassthrough_Public_OculusXRPassthroughColorLut_h__Script_OculusXRPassthrough_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRPassthrough_Public_OculusXRPassthroughColorLut_h__Script_OculusXRPassthrough_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRPassthrough_Public_OculusXRPassthroughColorLut_h__Script_OculusXRPassthrough_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRPassthrough_Public_OculusXRPassthroughColorLut_h__Script_OculusXRPassthrough_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRPassthrough_Public_OculusXRPassthroughColorLut_h__Script_OculusXRPassthrough_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRPassthrough_Public_OculusXRPassthroughColorLut_h__Script_OculusXRPassthrough_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
