...
FClassRegistrationInfo Z_Registration_Info_UClass_UBPNode_InitializePersistentPassthrough;
UClass* UBPNode_InitializePersistentPassthrough::GetPrivateStaticClass()
{
	using TClass = UBPNode_InitializePersistentPassthrough;
	if (!Z_Registration_Info_UClass_UBPNode_InitializePersistentPassthrough.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("BPNode_InitializePersistentPassthrough"),
			Z_Registration_Info_UClass_UBPNode_InitializePersistentPassthrough.InnerSingleton,
			StaticRegisterNativesUBPNode_InitializePersistentPassthrough,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UBPNode_InitializePersistentPassthrough.InnerSingleton;
}
UClass* Z_Construct_UClass_UBPNode_InitializePersistentPassthrough_NoRegister()
{
	return UBPNode_InitializePersistentPassthrough::GetPrivateStaticClass();
}
...
// ********** Begin Class UBPNode_InitializePersistentPassthrough constinit property declarations **
...
// ********** End Class UBPNode_InitializePersistentPassthrough constinit property declarations ****
...
// ********** Begin Class UBPNode_InitializePersistentPassthrough Property Definitions *************
...
// ********** End Class UBPNode_InitializePersistentPassthrough Property Definitions ***************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UBPNode_InitializePersistentPassthrough);
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRUncookedOnly_Private_BPNode_InitializePersistentPassthrough_h__Script_OculusXRUncookedOnly_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBPNode_InitializePersistentPassthrough, UBPNode_InitializePersistentPassthrough::StaticClass, TEXT("UBPNode_InitializePersistentPassthrough"), &Z_Registration_Info_UClass_UBPNode_InitializePersistentPassthrough, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBPNode_InitializePersistentPassthrough), 1029388073U) },
	};
}; // Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRUncookedOnly_Private_BPNode_InitializePersistentPassthrough_h__Script_OculusXRUncookedOnly_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRUncookedOnly_Private_BPNode_InitializePersistentPassthrough_h__Script_OculusXRUncookedOnly_1141385775{
	TEXT("/Script/OculusXRUncookedOnly"),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRUncookedOnly_Private_BPNode_InitializePersistentPassthrough_h__Script_OculusXRUncookedOnly_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRUncookedOnly_Private_BPNode_InitializePersistentPassthrough_h__Script_OculusXRUncookedOnly_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
