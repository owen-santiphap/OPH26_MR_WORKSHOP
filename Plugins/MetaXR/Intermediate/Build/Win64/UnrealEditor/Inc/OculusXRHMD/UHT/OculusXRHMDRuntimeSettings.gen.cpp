...
{
	using TClass = UOculusXRHMDRuntimeSettings;
	...
	return Z_Registration_Info_UClass_UOculusXRHMDRuntimeSettings.InnerSingleton;
}
UClass* Z_Construct_UClass_UOculusXRHMDRuntimeSettings_NoRegister()
{
	return UOculusXRHMDRuntimeSettings::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_XrApi_MetaData[] = {
		{ "Category", "General" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/**\n\x09This selects the XR API that the engine will use. Epic Native OpenXR is the recommended API;\n\x09the OVRPlugin backend is deprecated and will be removed in a future release.\n\x09The OpenXR plugin must also be enabled to use Native OpenXR.\n\x09*/" },
#endif
		{ "ConfigRestartRequired", "TRUE" },
		{ "DisplayName", "XR API" },
		{ "ModuleRelativePath", "Public/OculusXRHMDRuntimeSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "This selects the XR API that the engine will use. Epic Native OpenXR is the recommended API;\nthe OVRPlugin backend is deprecated and will be removed in a future release.\nThe OpenXR plugin must also be enabled to use Native OpenXR." },
#endif
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bUseScenelessWorldLocking_MetaData[] = {
		{ "Category", "MR Utility Kit" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/**\n\x09 * When \"Sceneless World Locking\" is enabled the world locking feature is enabled even when\n\x09 * there is no scene loaded. The underlying mechanism spawns a spatial anchor to world lock against.\n\x09 * It is recommended to keep this disabled if working on non MR-apps.\n\x09 */" },
#endif
		{ "ModuleRelativePath", "Public/OculusXRHMDRuntimeSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "When \"Sceneless World Locking\" is enabled the world locking feature is enabled even when\nthere is no scene loaded. The underlying mechanism spawns a spatial anchor to world lock against.\nIt is recommended to keep this disabled if working on non MR-apps." },
#endif
	};
#endif // WITH_METADATA
...
// ********** Begin Class UOculusXRHMDRuntimeSettings constinit property declarations **************
	...
	static void NewProp_bHorizonOSVersionOverride_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bHorizonOSVersionOverride;
	static const UECodeGen_Private::FStructPropertyParams NewProp_MinOSVersion;
	static const UECodeGen_Private::FStructPropertyParams NewProp_TargetOSVersion;
	...
	static void NewProp_bPassthroughCameraAccessEnabled_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bPassthroughCameraAccessEnabled;
	...
	static void NewProp_bUseScenelessWorldLocking_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bUseScenelessWorldLocking;
...
void Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bPassthroughCameraAccessEnabled_SetBit(void* Obj)
{
	((UOculusXRHMDRuntimeSettings*)Obj)->bPassthroughCameraAccessEnabled = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bPassthroughCameraAccessEnabled = { "bPassthroughCameraAccessEnabled", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UOculusXRHMDRuntimeSettings), &Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bPassthroughCameraAccessEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bPassthroughCameraAccessEnabled_MetaData), NewProp_bPassthroughCameraAccessEnabled_MetaData) };
...
void Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_EnableWorldLock_SetBit(void* Obj)
{
	((UOculusXRHMDRuntimeSettings*)Obj)->EnableWorldLock = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_EnableWorldLock = { "EnableWorldLock", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UOculusXRHMDRuntimeSettings), &Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_EnableWorldLock_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EnableWorldLock_MetaData), NewProp_EnableWorldLock_MetaData) };
void Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bUseScenelessWorldLocking_SetBit(void* Obj)
{
	((UOculusXRHMDRuntimeSettings*)Obj)->bUseScenelessWorldLocking = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bUseScenelessWorldLocking = { "bUseScenelessWorldLocking", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UOculusXRHMDRuntimeSettings), &Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bUseScenelessWorldLocking_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bUseScenelessWorldLocking_MetaData), NewProp_bUseScenelessWorldLocking_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bHorizonOSVersionOverride,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_MinOSVersion,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_TargetOSVersion,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bPassthroughCameraAccessEnabled,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bUseScenelessWorldLocking,
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h__Script_OculusXRHMD_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOculusXRHMDRuntimeSettings, UOculusXRHMDRuntimeSettings::StaticClass, TEXT("UOculusXRHMDRuntimeSettings"), &Z_Registration_Info_UClass_UOculusXRHMDRuntimeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRHMDRuntimeSettings), 3437713555U) },
	};
}; // Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h__Script_OculusXRHMD_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h__Script_OculusXRHMD_3046006394{
	TEXT("/Script/OculusXRHMD"),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h__Script_OculusXRHMD_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h__Script_OculusXRHMD_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h__Script_OculusXRHMD_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h__Script_OculusXRHMD_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
