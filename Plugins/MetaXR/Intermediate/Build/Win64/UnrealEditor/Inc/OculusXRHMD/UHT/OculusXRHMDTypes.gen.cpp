...
{
	if (!Z_Registration_Info_UScriptStruct_FOculusXRHmdUserProfileField.InnerSingleton)
	{
...
{
	if (!Z_Registration_Info_UScriptStruct_FOculusXRHmdUserProfile.InnerSingleton)
	{
...
struct Z_Construct_UEnum_OculusXRHMD_EOculusXRXrApi_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/OculusXRHMDTypes.h" },
		{ "NativeOpenXR.DisplayName", "Epic Native OpenXR (Recommended)" },
		{ "NativeOpenXR.Name", "EOculusXRXrApi::NativeOpenXR" },
		{ "NativeOpenXR.ToolTip", "Native OpenXR integration through the Epic OpenXR plugin with additional Meta XR features provided by this plugin. The OpenXR plugin must be enabled." },
		{ "OVRPluginOpenXR.DisplayName", "Meta XR with OVRPlugin (Deprecated - use Epic Native OpenXR)" },
		{ "OVRPluginOpenXR.Name", "EOculusXRXrApi::OVRPluginOpenXR" },
		{ "OVRPluginOpenXR.ToolTip", "The OVRPlugin backend is deprecated and will be removed in a future release. Switch to Epic Native OpenXR." },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
...
{
	if (!Z_Registration_Info_UScriptStruct_FOculusXRGuardianTestResult.InnerSingleton)
	{
...
{
	if (!Z_Registration_Info_UScriptStruct_FOculusXRSplashDesc.InnerSingleton)
	{
...
{
	if (!Z_Registration_Info_UScriptStruct_FOculusXRPerformanceMetrics.InnerSingleton)
	{
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h__Script_OculusXRHMD_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		...
		{ EOculusXRXrApi_StaticEnum, TEXT("EOculusXRXrApi"), &Z_Registration_Info_UEnum_EOculusXRXrApi, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3845707024U) },
...
}; // Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h__Script_OculusXRHMD_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h__Script_OculusXRHMD_1207844328{
	TEXT("/Script/OculusXRHMD"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h__Script_OculusXRHMD_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h__Script_OculusXRHMD_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h__Script_OculusXRHMD_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h__Script_OculusXRHMD_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
