...
UFunction* Z_Construct_UDelegateFunction_UOculusXREventComponent_OculusDisplayRefreshRateChangedEventDelegate__DelegateSignature()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_UOculusXREventComponent_OculusDisplayRefreshRateChangedEventDelegate__DelegateSignature_Statics::FuncParams);
	}
...
UFunction* Z_Construct_UDelegateFunction_UOculusXREventComponent_OculusEyeTrackingStateChangedEventDelegate__DelegateSignature()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_UOculusXREventComponent_OculusEyeTrackingStateChangedEventDelegate__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
...
{
	using TClass = UOculusXREventComponent;
	...
	return Z_Registration_Info_UClass_UOculusXREventComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UOculusXREventComponent_NoRegister()
{
	return UOculusXREventComponent::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXREventComponent_h__Script_OculusXRHMD_Statics
{
...
}; // Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXREventComponent_h__Script_OculusXRHMD_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXREventComponent_h__Script_OculusXRHMD_3710868549{
	TEXT("/Script/OculusXRHMD"),
	Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXREventComponent_h__Script_OculusXRHMD_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Target_MR_Claude_Plugins_MetaXR_Source_OculusXRHMD_Public_OculusXREventComponent_h__Script_OculusXRHMD_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
