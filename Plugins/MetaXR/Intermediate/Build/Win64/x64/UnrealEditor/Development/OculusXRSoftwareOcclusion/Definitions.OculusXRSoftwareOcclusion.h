...
#undef OCULUSXRSOFTWAREOCCLUSION_NON_ATTRIBUTED_API
...
#define OCULUSXRSOFTWAREOCCLUSION_API DLLEXPORT 
#define OCULUSXRSOFTWAREOCCLUSION_NON_ATTRIBUTED_API DLLEXPORT
